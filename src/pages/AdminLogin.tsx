        ...
        <div className="w-full max-w-md">
          <Card className="bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl text-white font-bold">Admin Portal</CardTitle>
              <CardDescription>
                <span className="text-gray-300">Sign in as an admin to manage the competition</span>
              </CardDescription>
            </CardHeader>
            <CardContent>
